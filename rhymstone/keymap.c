...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [Base] = LAYOUT_ortho_4x10(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, L1_0401, L1_0402, /**/ L1_0403, L1_0404, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [Nav] = LAYOUT_ortho_4x10(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, L2_0401, L2_0402, /**/ L2_0403, L2_0404, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [Num] = LAYOUT_ortho_4x10(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, L3_0401, L3_0402, /**/ L3_0403, L3_0404, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [Fun] = LAYOUT_ortho_4x10(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, L4_0401, L4_0402, /**/ L4_0403, L4_0404,  XXXXXXX, XXXXXXX, XXXXXXX
    )
};
